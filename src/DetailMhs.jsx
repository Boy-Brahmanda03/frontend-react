...
function DetailMhs() {
	...
	useEffect(() => {
		fetch(
			`https://ppl2024-krs-backend-gdjr2.ondigitalocean.app/api/mahasiswa/krs/${nim}`
		)
			.then((res) => res.json())
			.then((data) => {
				console.log(
	...
	useEffect(() => {
		fetch(
			`https://ppl2024-krs-backend-gdjr2.ondigitalocean.app/api/mahasiswa/nim/${nim}`
		)
			.then((res) => res.json())
			.then((data) => {
				console.log(data);
	...
	return (
		<>
			<div className="my-4 text-center">
				...
				<div className="inline-flex align-it rounded-md shadow-sm" role="group">
